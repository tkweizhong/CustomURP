...
namespace UnityTemplateProjects
{
    ...
    {
        public bool enableFramebuffer_sRGB;
        ...
        private bool m_RecordTag = false;
        ...
        void OnEnable()
        {
            ...
            {
                if (Camera.allCameras[i] != null && Camera.allCameras[i].tag == "UICamera" )
                {
                    m_UICamera = Camera.allCameras[i];
                    break;
                }
            }
            UpdateForwardRenderTag();
        }
        ...
        //private void OnGUI()
        //{
        //    if ( GUI.Button(new Rect(0, 100, 200, 100), GL.sRGBWrite ? "Disable-sRGB" :"Enable-sRGB"  ) )
        //    {
        //        GL.sRGBWrite = !GL.sRGBWrite;
        //        Debug.Log("Framebuffer_sRGB: " + GL.sRGBWrite);
        //    }

        //    if (GUI.Button(new Rect(0, 210, 200, 100), m_RecordTag ? "to-builtin" : "to-custom"))
        //    {
        //        UpdateForwardRenderTag();
        //    }
        //}

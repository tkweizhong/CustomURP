...
namespace UnityEditor.Rendering.Universal
{
    ...
    class UniversalRenderPipelineCameraEditor : CameraEditor
    {
        ...
        internal class Styles
        {
            ...
            public static GUIContent uiRenderScaleType = EditorGUIUtility.TrTextContent("Render UI Scale", "Makes UI camera render with different dimensions");
        ...
        SerializedProperty m_AdditionalCameraDataRenderUIScaleProp;
        ...
        void init(UniversalAdditionalCameraData additionalCameraData)
        {
            ...
            m_AdditionalCameraDataRenderUIScaleProp = m_AdditionalCameraDataSO.FindProperty("m_UIRenderScale");
...
//#endif
        ...
        void DrawUIRenerScale()
        {
            float selectedValueUIRenderScale;
            m_AdditionalCameraDataSO.Update();
            selectedValueUIRenderScale = m_AdditionalCameraData.uiRenderScale;
            Rect controlRectUIRenderScale = EditorGUILayout.GetControlRect(true);

            EditorGUI.BeginProperty(controlRectUIRenderScale, Styles.uiRenderScaleType, m_AdditionalCameraDataRenderUIScaleProp);
            EditorGUI.Slider(controlRectUIRenderScale, m_AdditionalCameraDataRenderUIScaleProp, 0.1f, 2f);
            m_AdditionalCameraDataSO.ApplyModifiedProperties();
            EditorGUI.EndProperty();
        }

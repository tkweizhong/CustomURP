...
[AddComponentMenu("Universal/VelocityBufferTag")]
public class VelocityBufferTag : MonoBehaviour
{
    ...
    [NonSerialized, HideInInspector] public SkinnedMeshRenderer skinnedMeshRenderer;
    [NonSerialized, HideInInspector] public bool skinnedMeshRendererActive;
    ...
    void Reset()
    {
        ...
        if (smr != null)
        {
            if (mesh == null || skinnedMeshRendererActive == false)
            {
                mesh = new Mesh();
                mesh.hideFlags = HideFlags.HideAndDontSave;
            }

            skinnedMeshRendererActive = true;
        ...
        else
        {
            ...
            skinnedMeshRendererActive = false;
    ...
    {
        if (skinnedMeshRendererActive && skinnedMeshRenderer == null)
        {
            Reset();
        }

        if (skinnedMeshRendererActive)
        {
            if (restart)
            {

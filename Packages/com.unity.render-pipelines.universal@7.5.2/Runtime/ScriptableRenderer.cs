...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public abstract class ScriptableRenderer : IDisposable
    {
        ...
        internal NativeArray<RenderPassEvent> m_BlockEventLimits;
        ...
        //Configure blockEventLimit in constructor function;Don't configure it each frame;  
        private void ConfigureBlockEventLimit()
        {
            // Upper limits for each block. Each block will contains render passes with events below the limit.
            m_BlockEventLimits = new NativeArray<RenderPassEvent>(k_RenderPassBlockCount, Allocator.Persistent);
        ...
        public void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            NativeArray<int> blockRanges = new NativeArray<int>(m_BlockEventLimits.Length + 1, Allocator.Temp);
            ...
            FillBlockRanges(m_BlockEventLimits, blockRanges);
        ...
        void SetRenderPassAttachments(CommandBuffer cmd, ScriptableRenderPass renderPass, ref CameraData cameraData, ref bool firstTimeStereo)
        {
            ...
            if (RenderingUtils.IsMRT(validColorBuffersCount))
            {
        ...
        void FillBlockRanges(NativeArray<RenderPassEvent> blockEventLimits, NativeArray<int> blockRanges)
        {
            ...
            {
                while (currRenderPassIndex < m_ActiveRenderPassQueue.Count &&
                    m_ActiveRenderPassQueue[currRenderPassIndex].renderPassEvent < blockEventLimits[i])
                    currRenderPassIndex++;

                blockRanges[currRangeIndex++] = currRenderPassIndex;
            }

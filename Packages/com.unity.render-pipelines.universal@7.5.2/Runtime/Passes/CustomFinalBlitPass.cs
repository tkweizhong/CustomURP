namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// consideration.
    /// </summary>
    public class CustomFinalBlitPass : ScriptableRenderPass
    {
        const string m_ProfilerTag = "Custom Final Blit Pass(sRGBToLinear)";
        RenderTargetHandle m_Source;
        Material m_BlitMaterial;
        TextureDimension m_TargetDimension;

        public CustomFinalBlitPass(RenderPassEvent evt, Material blitMaterial)
        {
